...
class FrameSecuencialDesordenado(FramePersonalizadoExtra):
    ...
    def iterativo(self):
        resultado = self.mensajero.iterativo(int(self.campo2.obtener_datos()), self.arreglo)
        self.area_texto.mostrar_texto_individual(resultado)
    def recursivo(self):
        resultado = self.mensajero.recursivo(self.arreglo,self.tamaño,  int(self.campo2.obtener_datos()),cont=0)
        self.area_texto.mostrar_texto_individual(resultado)

...
from interfaz_grafica.frames_unidades.unidad6.busqueda_binaria.BusquedaBinaria import BusquedaBinaria
from tkinter import Frame, simpledialog, messagebox
class FrameBusquedaBinaria(FramePersonalizadoExtra):

    def __init__(self, master, titulo):
        super().__init__(master=master, titulo=titulo)
        self.seleccion = "iterativo"
        self.separacion = 100
        self.mensajero = BusquedaBinaria()
        ...
        self.iterativo_bandera_boton = BotonSeleccionManera(master=self, nombre_boton="iterativo bandera",nombre_funcion=self.seleccion_iterativo_bandera)
        self.iterativo_bandera_boton.place(x=189, y=75)


        self.recursivo_boton = BotonSeleccionManera(master=self, nombre_boton="recursivo", nombre_funcion=self.seleccion_recursivo)
        self.recursivo_boton.place(x=339, y=75)
    ...
    def seleccion_iterativo(self):
        ...
        self.iterativo_bandera_boton.deseleccionado()
    ...
    def seleccion_iterativo_bandera(self):
        self.seleccion = "iterativo bandera"
        self.iterativo_bandera_boton.seleccionado()
        self.iterativo_boton.deseleccionado()
        self.recursivo_boton.deseleccionado()
        self.limpiar_valores()
    ...
    def iterativo_bandera(self):
        resultado = self.mensajero.iterativo_bandera(self.arreglo, int(self.campo2.obtener_datos()))
        self.area_texto.mostrar_texto_individual(resultado)
    ...
    def opcion_seleccionada(self):
        ...
        elif self.seleccion == "iterativo bandera":
            self.iterativo_bandera()

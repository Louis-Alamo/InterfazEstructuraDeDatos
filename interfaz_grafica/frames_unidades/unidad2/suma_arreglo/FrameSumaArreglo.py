...
from interfaz_grafica.frames_unidades.unidad2.suma_arreglo.SumaArreglo import SumaArreglo
from tkinter import messagebox, simpledialog
from numpy import zeros



class FrameSumaArreglo(FramePersonalizadoExtra):
    ...
    def realizar_impresiones(self):
        ...
        if self.seleccion == "iterativo":
            resultado = self.comunicador.suma_iterativa(self.arreglo)
        elif self.seleccion == "recursivo":
            resultado = self.comunicador.suma_recursiva(self.arreglo)

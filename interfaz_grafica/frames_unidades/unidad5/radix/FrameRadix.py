...
from interfaz_grafica.frames_unidades.unidad5.radix.Radix import RadixSort
from PIL import Image,ImageTk
from tkinter import messagebox,simpledialog, Frame
from numpy import *

class FrameRadix(FramePersonalizadoExtra):
    ...
    def __init__(self, master, titulo):
        ...
        self.comunicador = RadixSort()

        self.radix_boton = BotonSeleccionManera(master=self, nombre_boton="Radix", nombre_funcion=self.radix_funcion)
        self.radix_boton.place(x=39, y=75)
    ...
    def ordenar_datos(self):
        ...
        self.pasadas, self.movimientos, self.comparaciones = self.comunicador.radixsort(arreglo)

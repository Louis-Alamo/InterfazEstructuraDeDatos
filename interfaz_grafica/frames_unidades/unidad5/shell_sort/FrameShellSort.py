...
from interfaz_grafica.frames_unidades.unidad5.shell_sort.ShellSort import ShellSort
from PIL import Image,ImageTk
from tkinter import messagebox,simpledialog, Frame
from numpy import *

class FrameShellSort(FramePersonalizadoExtra):
    ...
    def __init__(self, master, titulo):
        ...
        self.comunicador = ShellSort()

        self.shell_sort = BotonSeleccionManera(master=self, nombre_boton="ShellSort", nombre_funcion=self.shell_sort_funcion)
        self.shell_sort.place(x=39, y=75)
        ...
        self.shell_sort_funcion()


    def shell_sort_funcion(self):
        print("Funciona mayor")
        self.shell_sort.seleccionado()
    ...
    def ordenar_datos(self):
        ...
        self.pasadas, self.movimientos, self.comparaciones = self.comunicador.shell_sort(arreglo)
